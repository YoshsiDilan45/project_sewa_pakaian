...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset('front-end/fonts/font-awesome-4.7.0/css/font-awesome.min.css')}}">
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset('front-end/fonts/iconic/css/material-design-iconic-font.min.css')}}">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{asset('front-end/vendor/perfect-scrollbar/perfect-scrollbar.css')}}">
<!--===============================================================================================-->
	...
	<header class="header-v2">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="{{asset('front-end/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
			</div>
	...
	<header class="header-v4">
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li @if ($title === 'Shop') class="active-menu" @endif>
					<a href="./shop">Shop</a>
				</li>
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="{{asset('front-end/images/icons/icon-close.png')}}" alt="CLOSE">
				</button>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="{{asset('front-end/images/product-detail-01.jpg')}}">
										<div class="wrap-pic-w pos-relative">
											<img src="{{asset('front-end/images/product-detail-01.jpg')}}" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="{{asset('front-end/images/product-detail-02.jpg')}}">
										<div class="wrap-pic-w pos-relative">
											<img src="{{asset('front-end/images/product-detail-02.jpg')}}" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="{{asset('front-end/images/product-detail-03.jpg')}}">
										<div class="wrap-pic-w pos-relative">
											<img src="{{asset('front-end/images/product-detail-03.jpg')}}" alt="IMG-PRODUCT">
