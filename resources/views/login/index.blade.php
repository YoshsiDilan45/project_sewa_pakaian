...
<head>
    ...
    <link href="back-end/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="back-end/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="email" placeholder="email" name="email" value="{{ old('email') }}" class="form-control" id="floatingInput" placeholder="name@example.com" required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4" id=save >Sign In</button>
